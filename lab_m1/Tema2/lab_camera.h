...
namespace implemented
{
    ...
    public:
        ...
        // Metodă pentru setarea matricei de proiecție
        void SetProjectionMatrix(const glm::mat4& matrix) {
            projectionMatrix = matrix;
        }

        // Funcție pentru a obține matricea de proiecție (dacă este necesar)
        ...
        void SetNewPosition(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up)
        {
            this->position = position;
            forward = glm::normalize(center - position);
            right = glm::cross(forward, up);
