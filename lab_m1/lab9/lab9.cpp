...
void Lab9::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
    ...
    if (texture1->GetTextureID() == mapTextures["earth"]->GetTextureID()) {
        rotate_texture = 1;
    }
    ...
    int loc_second_texture = glGetUniformLocation(shader->program, "second_texture");
    glUniform1i(loc_second_texture, second_texture);
