...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            //pozitia, normala(orientarea), culoarea
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0.6f, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // stanga jos fata 0
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, -1,  1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // dreapta jos fata 1
            VertexFormat(glm::vec3(-1, 1,  1), glm::vec3(0.6f, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // stanga sus fata 2
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // dreapta sus fata 3

            VertexFormat(glm::vec3(-1, -1,  -1), glm::vec3(0.6f, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // stanga jos spate 4
            VertexFormat(glm::vec3(1, -1,  -1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // dreapta jos spate 5
            VertexFormat(glm::vec3(-1, 1,  -1), glm::vec3(0.6f, 0, 1), glm::vec3(0.2, 0.8, 0.6)), // stanga sus spate 6
            VertexFormat(glm::vec3(1, 1,  -1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // dreapta sus spate 7
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0.4f, 0.7f)), // dreapta sus fata 0
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(1, 1, 1)), // stanga sus spate 1
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(1, 0.4f, 0.7f)), // dreapta jos spate 2
            VertexFormat(glm::vec3(-1, -1, 1), glm::vec3(1, 1, 1)) // stanga jos fata 3
        };
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(1,1,0), glm::vec3(0, 0, 1)), // sus dreapta 0
            VertexFormat(glm::vec3(1,-1,0), glm::vec3(0, 0, 1)), // jos dreapta 1
            VertexFormat(glm::vec3(-1,1,0), glm::vec3(0, 0, 1)), // sus stanga 2
            VertexFormat(glm::vec3(-1,-1,0), glm::vec3(0, 0, 1)) // jos stanga 3
        };
        ...
        meshes["opp square"] = new Mesh("generated opp square");
        meshes["opp square"]->InitFromData(vertices, indices);
    };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0, 0.5f, -2.5f), glm::vec3(0.25f));
    ...
    RenderMesh(meshes["opp square"], shaders["VertexColor"], glm::vec3(2.5f, 0.5f, 0), glm::vec3(0.25f));
